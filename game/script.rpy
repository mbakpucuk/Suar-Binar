...
define u = Character("Tetangga 2", color="#52445b", image='tetangganpcdua')
...
label kosan:
    ...
    #play sound "suara wasweswos.mp3"
    ...
    #play sound "suara gedubrak pintu.mp3"
    # with layar goyang
    #play sound "suara orang jatuh.mp3"
    ...
    u "Kami tau, ini pasti bukan pertama kali kalian seperti ini! Jangan kira kami nggak tau!"
    ...
    show tetangganpctiga at left
    show tetangganpc at right
    ...
    p "(Ini semua salahku... Kalau saja aku bisa melakukan sesuatu… Kalau saja aku sempat meminta maaf kepadanya sebelum dia pergi untuk selamanya…)"
...
label choice_2e:
    ...
    p "Kamu siapa? Bagaimana kau bisa tahu tentangku?"
...
label choice_1f:
    p "Tapi kenapa semuanya harus berakhir begini? Kenapa Reza harus jadi korban dan aku terus disalahkan?"
...
label choice_2f:
    ...
    p smile "Aku sudah memikirkannya. Semua yang terjadi mungkin memang takdirku."
    p "Aku tahu aku telah membuat banyak kesalahan, tapi aku memilih untuk menerima semua itu."
    p "Aku tak bisa terus-menerus menyalahkan diriku. Jika ini jalanku, aku ingin melanjutkannya tanpa penyesalan."
...
label timeskip:
    scene sky
    #play music "musiknya ending.mp3"
    ...
    #play sound "srek keambil gt.mp3"
    p "Hah? Dompetku?! Kok nggak ada?!"
    ...
    p mikir "Tadi aku pasti bawa kok, aku ingat jelas dompet itu aku taruh di saku... Aduh, gimana ini?!"
...
label choice_1g:
    p "Duh kok nggak ada, pasti ini ada yang nyuri! Siapa sih yang berani-beraninya ambil dompet aku? Dasar nggak punya moral!"
    #play sound "hentak kaki.mp3"
    "Ia menghentakkan kaki dengan keras, tangannya mengepal sambil menggerutu."
    p "Dasar maling nggak tau diri! Semoga semua harinya hari senin terus!"
...
label choice_2g:
    ...
    #play sound "srek srek.mp3"
    #play sound "nabrak org.mp3"
    ...
    p "Ah, maaf, maaf banget, saya nggak sengaja..."
    ...
    p cry "Reza, aku... aku nggak tahu harus ngomong apa. Aku sangat menyesal. Aku... aku salah banget waktu itu. Aku nggak bisa menghubungimu lagi, dan aku nggak tahu apa yang harus aku lakukan."
    ...
    p smile "Terima kasih sudah memberi aku kesempatan untuk menjelaskan. Aku... aku nggak tahu kalau kamu sudah melalui semua itu."
